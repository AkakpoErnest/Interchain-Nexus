...
/**
 * @title LiskSocialArchitectUnlimited
 * @dev Social Architect NFT contract for Lisk network - Unlimited supply version
 * Provides community building and social protocol features without supply limits
 */
contract LiskSocialArchitectUnlimited is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    
    Counters.Counter private _tokenIds;
    
    // No maximum supply limit for easier testing and deployment
    ...
    constructor() ERC721("Lisk Social Architect Unlimited", "SOCIAL-U") {
    ...
    /**
     * @dev Public mint function for easier testing
     * @param name The name of the Social Architect
     * @param title The title of the Social Architect
     */
    function publicMint(
        ...
        require(!_hasSocialArchitect[msg.sender], "Player already has Social Architect");
        ...
        _playerSocialArchitect[msg.sender] = newTokenId;
        _hasSocialArchitect[msg.sender] = true;
        
        _safeMint(msg.sender, newTokenId);
        
        emit SocialArchitectMinted(msg.sender, newTokenId, name);
    }
